NDefines = {
	...
	NDiplomacy = {
		...
		PEACE_CONTEST_REFUND_FACTOR = { 1.0, 0.92, 0.84, 0.76 }, -- How much of the spent peace conference score that gets Buildingrefunded in a contest. First element applies for the first round of conflicts, second element for the second round of conflicts, etc. The final element is used for each consecutive turn, so setting that to e.g. 0.7 means you get 70 % of the spent score back for every turn thereafter.
	...
	NCountry = {
		...
		POLITICAL_POWER_UPPER_CAP = 2500.0,				-- Max amount of political power country should have
