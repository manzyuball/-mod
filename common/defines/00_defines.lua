...
NCountry = {
	...
	BASE_MAX_COMMAND_POWER = 350.0,					-- base value for maximum command power
	BASE_COMMAND_POWER_GAIN = 0.8,					-- base value for daily command power gain
...
NBuildings = {
	...
	MAX_SHARED_SLOTS = 45,				-- Max slots shared by factories
...
NMilitary = {
	...
	COMBAT_MINIMUM_TIME = 4,			-- Shortest time pos100sible for a combat in hours
...
NIntel = {
	...
	ARMY_INTEL_COMBAT_BONUS_FACTOR_ATTACK = 1.0, -- multiplier for attack v500alue of intel combat bonus
